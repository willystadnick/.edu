...
//requere arquivo token.php (onde esta a classe Automato) 
require("token.php");
//define a variavel $compilador como Classe Token
$compilador = new token();
...
<form action="" method="post" name="rotina">
			...
			<input type="submit" name="Submit" value="Compilar"> <input type="submit" name="limpar" value="Limpar Campos">
